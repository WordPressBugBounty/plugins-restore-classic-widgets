...
function bill_install_mu_plugin()
{
    ...
    */
    ...
    try {
        ...
        // Define the plugin file path in the restore_classic_widgets directory
        $source = $restore_classic_widgets_mu_plugin_dir . '/' . $plugin_file;
...
add_action("wp_ajax_bill_minozzi_js_error_catched", "restore_classic_widgets_BillCatchErrors\\bill_minozzi_js_error_catched");
add_action("wp_ajax_nopriv_bill_minozzi_js_error_catched", "restore_classic_widgets_BillCatchErrors\\bill_minozzi_js_error_catched");
...
class restore_classic_widgets_bill_catch_errors
{
...
new restore_classic_widgets_bill_catch_errors();
//
